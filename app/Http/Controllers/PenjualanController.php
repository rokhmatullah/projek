...
class PenjualanController extends Controller
{
    ...
    public function show($invoice)
    {
        ...
        $penjualan = Penjualan::where('penjualan_invoice', $id)->with( 'kostumer', 'penjualanItem', 'penjualanItem.barang', 'penjualanBayar')->firstOrFail();
    ...
    {
        $id = str_replace('-', '/', $invoice);
        $penjualan = Penjualan::where('penjualan_invoice', $id)->with('kostumer', 'penjualanItem', 'penjualanItem.barang', 'penjualanItem.barang.kategori', 'penjualanBayar')->firstOrFail();
