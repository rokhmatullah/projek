...
@section('staff_content_title')
    <button class="btn btn-warning"><h1 class="m-0 text-dark">Invoice Penjualan</h1></button>
@endsection
...
<div class="card bg-success shadow-lg">
    <div class="card-header bg-primary no-border">
        <h3 class="card-title">
            <i class="fa fa-globe"></i> {{ '#'.$penjualan->penjualan_invoice }}
            <small class="pull-right hidden-lg-down">{{ formated_date(now()) }}</small>
        </h3>
    </div>
    <div class="card-body">
        <div class="row mb-3">
        ...
        <div class="row">
            <div class="col-12 table-responsive">
                <table class="table table-hover table-responsive-sm table-striped w-100">
                    <thead>
                        <tr>
                            <th>Nama Barang</th>
                            <th>Harga @</th>
...
<script>
    $(document).ready(function(){
        document.title = "AnaPen | Invoice Penjualan";
