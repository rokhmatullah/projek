...
@section('staff_content_title')
    <button class="btn btn-warning"><h1 class="m-0 text-dark">Penjualan</h1></button>
@endsection
...
<div class="card">
    <div class="card-header bg-success no-border">
        <h3 class="card-title">
            <i class="fa fa-money"> List Penjualan</i>
            <a class="btn btn-primary btn-sm text-white float-right" href="{{ url('staff/penjualan/create') }}"><i class="fa fa-plus shadow"></i> Tambah Transaksi</a>
        </h3>
    </div>
    <div class="card-body shadow">
        ...
        <table class="table table-bordered table-hover table-responsive-sm table-striped" id="penjualanTable">
            <thead>
                <tr class="bg-primary">
                    <th class="all">No</th>
...
<script>
    $(document).ready(function(){
        document.title = "AnaPen | List Penjualan";
        ...
        swal({
            ...
            if (value) {
                ...
                swal({
                    icon: "error",
                    title: "Gagal!",
                    text: "Anda Telah Membatalkan Proses Hapus!",
                });
            }
        });
    }
