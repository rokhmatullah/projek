...
@section('staff_content_title')
    <button class="btn btn-warning"><h1 class="m-0 text-dark">Pelanggan</h1></button>
@endsection
        ...
        <div class="col-12 col-lg-4">{{-- Form Kostumer --}}
            <div class="card bg-success shadow-lg">
                <div class="card-header no-border">
                    <h3 class="card-title"><i class="fa fa-users"></i> Form Input Pelanggan</h3>
                </div>
        ...
        <div class="col-12 col-lg-8">{{-- DataTable Kostumer --}}
            <div class="card shadow">
                <div class="card-header bg-success no-border">
                    <h3 class="card-title"><i class="fa fa-users"></i> List Kostumer</h3>
                </div>
                <div class="card-body">
...
<script>
    $(document).ready(function(){
        document.title = "AnaPen | Pelanggan";
    ...
    function formDelete(id){
        var kostumer_id = id;
        var url_link = '{{ url('staff/kostumer') }}/'+id;
