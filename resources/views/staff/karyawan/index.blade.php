...
@section('staff_content_title')
    <button class="btn btn-warning"><h1 class="m-0 text-dark">Karyawan</h1></button>
@endsection
...
@section('staff_content')
    <div class="row">
        <div class="col-12 col-lg-4">{{-- Form Karyawan --}}
            <div class="card bg-success shadow-lgs">
                <div class="card-header no-border">
                    <h3 class="card-title"><i class="fa fa-user"></i> <span id="span_title">Form Input Karyawan</span></h3>
                </div>
                <form role="form" id="karyawanForm">
                    <div class="card-body">
                        ...
                        <div class="form-group" id="field-email">{{-- Email --}}
                            ...
                            <input type="email" name="email" class="form-control" placeholder="mail@gmail.com" id="input-email">
                        </div>{{-- /.Email --}}
        ...
        <div class="col-12 col-lg-8">{{-- DataTable Karyawan --}}
            <div class="card shadow">
                ...
                <div class="card-body">
                    <table class="table table-hover table-responsive-sm table-striped table-bordered" id="karyawanTable">
                        <thead>
                            <tr class="bg-primary">
                                <th>No</th>
...
<script>
    $(document).ready(function(){
        document.title = "AnaPen | Karyawan";
        ...
        columnDefs: [
            {
                ...
                render: function(data, type, row) {
                    ...
                    return generateButton(id, name, username, email, password, status);
                }
            }
        ],
        pageLength: 5,
    ...
    function generateButton(id, name, username, email, password, status){
        var edit = '<a class="btn btn-warning text-white" onclick="formUpdate('+id+','+name+','+username+','+email+','+password+')"></i><i class="fa fa-edit"></i></a>';
        if(status == "Aktif"){
    ...
    function formUpdate(id, name, username, email, password){
    ...
    function formReset(){
        ...
        $("#span_title").text('Form Input Karyawan');
        $("#request").val('insert');
        $("#_method").val('POST');
        $("#user_id").val('');
