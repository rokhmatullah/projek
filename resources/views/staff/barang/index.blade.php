...
<button class="btn btn-warning"><h1 class="m-0 text-dark">Barang</h1></button>
@endsection
        ...
        <div class="col-12 col-lg-4">{{-- Form Barang --}}
            <div class="card bg-success">
                <div class="card-header no-border">
                    <h3 class="card-title"><i class="fa fa-th"></i> Form Input Barang</h3>
                </div>

                <form role="form" class="shadow" id="barangForm">
                    <div class="card-body">
        ...
        <div class="col-12 col-lg-8">{{-- DataTable Barang --}}
            <div class="card shadow">
                <div class="card-header bg-success no-border">
                    <h3 class="card-title"><i class="fa fa-th"></i> List Barang</h3>
                </div>
                <div class="card-body">
                    <table class="table table-hover table-striped table-bordered table-responsive-sm" id="barangTable">
                        <thead>
                            <tr class="bg-primary">
                                <th>No</th>
                ...
                <div class="modal-body">
                    <form role="form" id="kategoriForm">{{-- Form Start --}}
                        <div class="form-group" id="field-kategori_kd">{{-- Kode Kategori --}}
                            ...
                            <label class="text-muted mb-0"><small>*Maksimal 10 kode</small></label>
                        </div>{{-- /.Kode Kategori --}}
