...
@section('staff_content_title')
    <button class="btn btn-warning"><h1 class="m-0 text-dark">Kategori</h1></button>
@endsection
        ...
        <div class="col-12 col-lg-4">{{-- Form Kategori --}}
            <div class="card bg-success">
                <div class="card-header no-border">
                    <h3 class="card-title"><i class="fa fa-tags"></i> Form Input Kategori</h3>
                </div>
                <form role="form" id="kategoriForm" class="shadow">
                    <div class="card-body">
                        ...
                        <div class="form-group" id="field-kategori_kode">{{-- Kode Kategori --}}
                            ...
                            <label class="text-white mb-0"><small>*Maksimal 10 kode</small></label>
                        </div>{{-- /.Kode Kategori --}}
        ...
        <div class="col-12 col-lg-8">{{-- DataTable Kategori --}}
            <div class="card shadow-lg">
                <div class="card-header bg-success no-border">
                    <h3 class="card-title"><i class="fa fa-tags"></i> List Kategori</h3>
                </div>
                <div class="card-body">
                    <table class="table table-hover table-striped table-bordered table-responsive-sm" id="kategoriTable">
                        <thead>
                            <tr class="bg-primary">
                                <th>No</th>
...
<script>
    $(document).ready(function(){
        document.title = "AnaPen | Kategori";
    ...
    function formDelete(id){
        ...
        swal({
            title: "Pengertian!",
            text: "Data Ini Akan Dihapus, Apakah Anda Yakin Untuk Menghapusnya?",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        }).then((value) => {
    ...
    function formReset(){
        ...
        $("#span_title").text(" Form Input Kategori ");
        $("#request").val('insert');
        $("#_method").val('POST');
        $("#kategori_id").val('');
